...
Spawn a stage agent as a subagent whose agent type is its name, give it the handoff packet, and wait for
its result before routing further. Its assigned skills are listed in its instructions.
